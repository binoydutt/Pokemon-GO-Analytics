# -*- coding: utf-8 -*-
"""
Created on Sat Apr 08 17:08:03 2017
Binoy Dutt
Priya Sanodia
        ...
        if files.endswith('android.html'):
            try:            
                ...
                try:
                    ...
                    a_total_ratings =0
                try:
                    a_5_rate = soup.find("div",{"class" : "rating-bar-container five"})
                    a_5_rating =int(a_5_rate.get_text().split()[1].replace(',',''))
                except:
                    error_a_5_rating.append('{}/{}'.format(folder,files))
                    a_5_rating = 0
                try:
                    a_4_rate = soup.find("div",{"class" : "rating-bar-container four"})
                    a_4_rating =int(a_4_rate.get_text().split()[1].replace(',',''))
                except:
                    error_a_4_rating.append('{}/{}'.format(folder,files))
                    a_4_rating = 0
                try:
...
'error_a_5_rating':error_a_5_rating,
'error_a_4_rating':error_a_4_rating,
...
'Total_error_a_5_rating':len(error_a_5_rating),
'Total_error_a_4_rating':len(error_a_4_rating),
